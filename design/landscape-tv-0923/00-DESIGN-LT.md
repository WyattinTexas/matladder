...
- 9/23 21:20 PT: **BUILD 7 ON TESTFLIGHT** — uploaded 21:16, VALID 21:19 (id 5ce0afb7-5b5f-46e0-b2c0-a8a299649999), usesNonExemptEncryption PATCHed false, added to Friends 87221167… (+ Team). betaAppReviewSubmission REFUSED by Apple: ENTITY_UNPROCESSABLE.ANOTHER_BUILD_IN_REVIEW (build 6 still WAITING_FOR_REVIEW since 17:45) → ~/.appstoreconnect/footwork-build7-autosubmit.py (nohup, pid 30209, log beside it) polls every 5 min and POSTs build 7 once build 6 clears. Web live: matladder.com + /app/ (a0f0044) · drbango.com/ladder (DrBango b6e184a6). CARD-LT DONE.
